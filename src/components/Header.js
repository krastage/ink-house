      ...
      <div className={'container header-container'}>
        ...
        <nav>
          <ul className={'header__list'}>
            <li><a href="#reproductions" className={'header__link'}>Репродукции</a></li>
            <li><a href="#news" className={'header__link'}>Новинки</a></li>
            <li><a href="#team" className={'header__link'}>О нас</a></li>
            <li><a href="">
              <svg className={'header__link'} width="22" height="22" viewBox="0 0 22 22" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
                <g id="shopping-cart" clip-path="url(#clip0_8079_102)">
                  <path id="Vector"
                        ...
                        stroke="#2C2D35" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path id="Vector_2"
